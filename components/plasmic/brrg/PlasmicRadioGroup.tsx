...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: 5CDXW02Cf5r3/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__vbqwS)}
          >
            <Radio
              className={classNames("__wab_instance", sty.radio__sn1O4)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio___4BgW0)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__qimc9)}
              label={"Option 3"}
              value={"option3"}
            />
          </Stack__>
