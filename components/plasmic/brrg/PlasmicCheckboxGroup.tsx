...
import Checkbox from "../../Checkbox"; // plasmic-import: bVH_E4Bc7Tlx/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: 4qomIH_lUatF/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__m08AY)}
          >
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__h7F1V)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__mLea)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__dxnd6)}
              label={"Option 3"}
              value={"option3"}
            />
          </Stack__>
