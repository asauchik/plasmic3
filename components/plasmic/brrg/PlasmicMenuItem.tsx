...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: xSGMaPPAL8id/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__voYXj)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__yoeXm)}>
            <div
              className={classNames(
                projectcss.all,
