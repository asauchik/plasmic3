...
import SliderThumb from "../../SliderThumb"; // plasmic-import: oZEqnpN-hJVj/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: UfOly8xBaB_s/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__e7SvX)}
      >
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__treg0)}>
        <div
