...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: bVH_E4Bc7Tlx/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: R028J0nos2Me/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: dswozO6iMuA3/icon
...
function PlasmicCheckbox__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <CheckIcon
          className={classNames(projectcss.all, sty.svg__cn6Xg)}
          role={"img"}
        />

        <MinusIcon
          className={classNames(projectcss.all, sty.svg__dfvra)}
          role={"img"}
        />
      </div>
      {renderPlasmicSlot({
