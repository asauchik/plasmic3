...
import sty from "./PlasmicSlider.module.css"; // plasmic-import: JmkLApIWNQjf/css
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__hz6P7)}
        >
          {$props.showLabel ? (
            <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__lyjZq)}>
        <div
