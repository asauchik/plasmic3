...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: 4gP9wvKbXLVB/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: mPmo-hEW5LRJ/css
  ...
  return (
    <BaseDialogTrigger
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__emaK)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button__q0Gf9)}
            label={"Open Popover"}
          />
        ),
