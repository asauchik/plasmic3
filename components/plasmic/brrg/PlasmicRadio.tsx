...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: axBQP_Si1D03/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__bb1Z)}>
        <div className={classNames(projectcss.all, sty.freeBox__giTw)} />
      </div>
      {renderPlasmicSlot({
