...
import TextInput from "../../TextInput"; // plasmic-import: xXuw267c_NU-/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: UrMf7q03OE6h/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: G-FeDcez-l48/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__arPP, {
          [sty.freeBoxiconEnd__arPPudd9D]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__arPP5Nasc]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__arPPXqEpc]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__lJpvn, {
            [sty.freeBoxiconStart__lJpvn5Nasc]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__lJpvnXqEpc]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__vVjK)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox___2JRv, {
            [sty.freeBoxiconEnd___2JRvUdd9D]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart___2JRv5Nasc]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__wawTh)}
                role={"img"}
              />
            ),
