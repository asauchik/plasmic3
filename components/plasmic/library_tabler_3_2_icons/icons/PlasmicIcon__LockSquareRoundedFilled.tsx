...
export type LockSquareRoundedFilledIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function LockSquareRoundedFilledIcon(
  props: LockSquareRoundedFilledIconProps
) {
