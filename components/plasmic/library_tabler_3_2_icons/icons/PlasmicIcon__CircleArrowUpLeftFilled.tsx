...
export type CircleArrowUpLeftFilledIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function CircleArrowUpLeftFilledIcon(
  props: CircleArrowUpLeftFilledIconProps
) {
