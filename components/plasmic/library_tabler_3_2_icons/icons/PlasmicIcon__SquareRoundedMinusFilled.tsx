...
export type SquareRoundedMinusFilledIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function SquareRoundedMinusFilledIcon(
  props: SquareRoundedMinusFilledIconProps
) {
