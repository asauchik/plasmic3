...
export type SquareChevronsRightFilledIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function SquareChevronsRightFilledIcon(
  props: SquareChevronsRightFilledIconProps
) {
